...
CHECK ((FECHA_INICIAL < TO_DATE('02-02-2024', 'DD-MM-YYYY') OR FECHA_FINAL < TO_DATE('02-FEB-2024', 'DD-MON-YYYY'))
OR (FECHA_INICIAL > TO_DATE('28-03-2024', 'DD-MM-YYYY') OR FECHA_FINAL > TO_DATE('28-MAR-2024', 'DD-MON-YYYY')));
...
INSERT INTO CALADERO (CODIGO, NOMBRE, UBICACION, ESPECIE_PRINCIPAL, NOMBRE_CIENTIFICO)
VALUES ('C002', 'Caladero Sur', 'Zona Sur', 'E002', 'Thunnus thynnus');

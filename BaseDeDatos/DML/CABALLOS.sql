...
ADD CONSTRAINT CHK_JOCKEY_FORMAT 
CHECK (REGEXP_LIKE(JOCKEY, '^[A-Z][a-z]*$'));


ALTER TABLE CARRERAS 
ADD CONSTRAINT CHK_TEMPORADA_CARRERAS 
CHECK (TO_CHAR(FECHA_HORA, 'MM-DD') BETWEEN '03-10' AND '11-10');

ALTER TABLE CABALLOS 
ADD CONSTRAINT CHK_NACIONALIDAD_CABALLOS 
